...
def startG():
    """ function startG: no returns and no parameters
                ...
                Sets up the game for the cpu, auto teams, prints out winner
        """
...
def playGame():
    """ fnction playGame: no parameters, returns 1 integer
                ...
                function plays the game of cpu v cpu, depending on global integers, returns winner if checkmate/
